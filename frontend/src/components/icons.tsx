// Small inline-SVG icon set (matches the site's Figma design). Kept as plain
// functions rather than an icon library dependency - this is the full set the
// UI needs, all single-color/currentColor strokes so they inherit text color.
